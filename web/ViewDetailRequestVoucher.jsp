            ...
            <div class="row">
                <div class="col-xl-9 col-lg-10 col-md-12 col-sm-12 mx-auto">
                    <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
                        <div class="row">
                            <div class="col-12">
                                <h2 class="tm-block-title d-inline-block text-uppercase">Chi tiết yêu cầu làm voucher</h2>
                            </div>
                        </div>
                            ...
                            <div class="row tm-edit-product-row">
                                <div class="col-xl-6 col-lg-6 col-md-12">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input id="restaurantName" name="restaurantName" type="text" required value="${detail.restaurantName}" class="form-control read-only" readonly/>
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="voucherName">Voucher</label>
                                        <input id="voucherName" name="voucherName" type="text" required value="${detail.voucherName}" class="form-control read-only" readonly/>
                                    </div>
                                    <div class="form-group mb-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group mb-3 col-xs-12 col-sm-6">
                                            ...
                                            <c:set var="formattedDiscount">
                                                <fmt:formatNumber value="${detail.discount}" type="number" maxFractionDigits="0" />
                                            </c:set>
                                ...
                                <div class="col-12">
                                    <a href="loadListRequestVoucher" class="btn btn-primary btn-block text-uppercase">Trở lại</a>
                                </div>
                            </div>
                        </form>
                    </div>
