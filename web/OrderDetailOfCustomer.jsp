            ...
            <div class="row">
                <div class="col-xl-9 col-lg-10 col-md-12 col-sm-12 mx-auto">
                    <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
                                ...
                                <tbody>
                                    <c:forEach items="${listOrderDetail}" var="order">
                                        <tr>
                                            ...
                                            <td><fmt:formatNumber value="${order.totalMoney}" type="number" minFractionDigits="0" maxFractionDigits="0" /> đ</td>
                                            <td>${order.quantity}</td>
                                            <td><fmt:formatNumber value="${order.totalMoney * order.quantity}" type="number" minFractionDigits="0" maxFractionDigits="0" /> đ</td>
                                        </tr>
                                    </c:forEach>
                                </tbody>
                            </table>
                        ...
                        <div class="text-center">
                            <input type="button" class="btn btn-primary btn-block text-uppercase" value="Trở về" onclick="window.history.back();" />
                        </div>
                    </div>
                </div>
            </div>
