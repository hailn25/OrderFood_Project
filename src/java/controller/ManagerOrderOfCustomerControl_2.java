 ...
 * @author Vu Huy
 */
@WebServlet(name = "managerOrderOfCustomer_2", urlPatterns = {"/managerOrderOfCustomer_2"})
public class ManagerOrderOfCustomerControl_2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ManagerOrderOfCustomerControl_2.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
