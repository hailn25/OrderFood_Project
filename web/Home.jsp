                                ...
                                <c:forEach items="${listC}" var="c">
                                    <li class="nav-item">
                                        <div class="d-flex m-2 py-2 bg-light rounded-pill active">
                                            <a class="text-dark" style="width: 130px;" href="category?cid=${c.categoryId}">${c.name}</a>
                                        </div>
                                    </li>
                                </c:forEach>
                            </ul>
                                        ...
                                        <div class="col-md-6 col-lg-4 col-xl-3">
                                            <div class="rounded position-relative fruite-item">
                                                <div class="fruite-img">
                                                    <img style="height: 280px;" src="img/new/${p.image}" class="img-fluid w-100 rounded-top" alt="">
                                                </div>
                        ...
                        <div class="col-lg-6 col-xl-4">
                            <div class="p-4 rounded bg-light">
                                <div class="row align-items-center">
                                    <div class="col-6">
                                        <img src="img/new/${b.image}" class="img-fluid rounded-circle w-100" alt="${b.name}">
                                    </div>
                                    <div class="col-6">
                                        <a href="detail?pid=${b.id}" class="h5">${b.name}</a>
                                        <div class="d-flex my-3">
                                            <c:forEach begin="1" end="${b.rateStar}" var="star">
                                                <i class="fas fa-star text-primary"></i>
                                            </c:forEach>
                                            <c:forEach begin="1" end="${5 - b.rateStar}" var="star">
                            ...
                            <div class="position-relative">
                                ...
                                <div class="d-flex align-items-center flex-nowrap">
                                    <div class="bg-secondary rounded">
                                        <img src="img/new/${listFeedback.avatar}" class="img-fluid rounded" style="width: 100px; height: 100px;" alt="">
                                    </div>
                                    <div class="ms-4 d-block">
                                        <h4 class="text-dark">${listFeedback.name}</h4>
                                        <p class="m-0 pb-3">${listFeedback.nameProduct}</p>
                                        <div class="d-flex pe-5">
                                            <c:forEach begin="1" end="${listFeedback.rateStar}">
                                                <i class="fas fa-star text-primary"></i>
                                            </c:forEach>
                                            <c:forEach begin="${listFeedback.rateStar + 1}" end="5">
                                                <i class="fas fa-star"></i>
                                            </c:forEach>
                                        </div>
                                    </div>
