 ...
 * @author ADMIN
 */
@WebServlet(name = "CheckoutServlet1", urlPatterns = {"/checkout1"})
public class CheckoutServlet1 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        response.sendRedirect("Checkout_1.jsp");
    ...
    private void sendOrderConfirmationEmail(String name, String address, String phone, String email, Cart cart, String total, String note, OrderDAO dao) {
        ...
        try {
            ...
            Logger.getLogger(CheckoutServlet1.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
