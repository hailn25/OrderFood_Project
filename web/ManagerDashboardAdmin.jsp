...
<html lang="en">
    ...
    <head>
        ...
        <style>
            ...
            .info-square .icon-accounts {
                color: #2196F3;
            }
            .info-square .icon-stores {
                color: #FF9800;
            }
    ...
    <body id="reportsPage" style="background-color: #F6F6F6">
        <div class="" id="home">
            ...
            <div class="info-container">
                ...
                <div class="info-square">
                    <i class="fas fa-users icon icon-accounts"></i>
                    <div>
                        <h2>${totalAccounts}</h2>
                        <p>Tài khoản</p>
                    </div>
                ...
                <div class="info-square">
                    <i class="fas fa-store icon icon-stores"></i>
                    <div>
                        <h2>${totalStores}</h2>
                        <p>Nhà hàng</p>
                    </div>
        ...
        <script>
                ...
                function adjustFontSize(element) {
                    ...
                    if (element.innerText.length > maxLength) {
                        fontSize -= 0.1 * (element.innerText.length - maxLength);
                    }

                    element.style.fontSize = fontSize + 'em';
                }

                // Adjust font size for revenue text
                const revenueText = document.querySelector('.revenue-text');
                adjustFontSize(revenueText);
        </script>
