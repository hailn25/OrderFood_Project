                    ...
                    <div class="bg-light rounded">
                        <div class="p-4">
                            ...
                            <div class="d-flex justify-content-between mb-4">
                                ...
                                <span class="subtotal"><fmt:formatNumber value="${subtotal}" type="currency" currencySymbol="VND" maxFractionDigits="0"/></span>
                            </div>
                            <div class="py-4 mb-4 border-top border-bottom d-flex justify-content-between">
                                <h5 class="mb-0 ps-4 me-4">Total</h5>
                                <span class="cart-total"><fmt:formatNumber value="${subtotal}" type="currency" currencySymbol="VND" maxFractionDigits="0"/></span>
                            </div>
