 ...
 * @author hailt
 */
@WebServlet(name="ChangeStatusFlashSale", urlPatterns={"/changeStatusFlashSale"})
public class ChangeStatusFlashSale extends HttpServlet {
    ...
    throws ServletException, IOException {
        try {
            ...
            Logger.getLogger(ChangeStatusFlashSale.class.getName()).log(Level.SEVERE, null, ex);
        }
    } 
