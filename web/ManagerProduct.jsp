...
<html lang="en">
    ...
    <body id="reportsPage" style="background-color: #F6F6F6">
        ...
        <div class="container">
                    ...
                    <tbody>
                        <c:forEach items="${listP}" var="o">
                            <tr>
                                ...
                                <td>${o.price}</td>
                                <td>
                                    <img src="img/${o.imageURL}">
                                </td>

                                <td>
                                    <a href="EditProduct.jsp"  class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
            ...
            <a href="AddProduct.jsp" class="btn btn-primary btn-block text-uppercase mb-3">Add new product</a>
        </div>
